...
public class KeyStoreUtil {
     ...
     * @throws CertificateException     If one or more certificates can't be loaded into the
     *                                  KeyStore
     * @throws NoSuchAlgorithmException If the algorithm specified to validate the integrity of the
