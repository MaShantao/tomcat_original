...
public class TestChunkedInputFilter extends TomcatBaseTest {
    ...
    /**
     * @param expectPass          If the servlet is expected to process the request
     * @param expectReadWholeBody If the servlet is expected to fully read the body and reliably
     *                            deliver a response
     * @param chunks              Text of chunks
     * @param readLimit           Do not read more than this many bytes
     * @param expectReadCount     Expected count of read bytes
